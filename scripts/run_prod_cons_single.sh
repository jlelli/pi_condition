...
cat /debug/tracing/trace_stat/function0 > ${RESULTS_PATH}/stat_no_pi_${PROD}prod_${CONS}cons_${ANNOY}annoy_${AFF}.dat
...
echo 0 > /debug/tracing/function_profile_enabled
cat /debug/tracing/trace_stat/function0 > ${RESULTS_PATH}/stat_pi_${PROD}prod_${CONS}cons_${ANNOY}annoy_${AFF}.dat
